...
async function seedIfEmpty() {
  ...
  for (const e of entities) {
    await pool.query('INSERT INTO entities (id,name,sub,iban,balance) VALUES ($1,$2,$3,$4,$5)', e);
  }
  ...
  for (const e of employees) {
    await pool.query('INSERT INTO employees (id,entity_id,name,role,contract,gross,start_date) VALUES ($1,$2,$3,$4,$5,$6,$7)', e);
  }

  const hash = (pw) => bcrypt.hashSync(pw, 10);
  const users = [
    ['u1', 'Yanis Chojnacki', 'directeur', 'csr-group', 'e1', 'y.chojnacki@csrgroup.fr', hash('CSRgroup2026!')],
    ['u2', 'Solenne Saint-Rose', 'directeur', 'csr-group', 'e2', 'solenne.saintrose@csrgroup.fr', hash('CSRgroup2026!')],
    ['u3', 'Responsable boutique', 'responsable', 'pwa-dou', 'e3', 'responsable.pwadou@csrgroup.fr', hash('PwaDou2026!')],
    ['u4', 'Responsable atelier', 'responsable', 'koszmar', 'e4', 'responsable.koszmar@csrgroup.fr', hash('Koszmar2026!')],
    ['u5', 'Technicien formulation', 'employe', 'manufacture', 'e5', 'technicien.manufacture@csrgroup.fr', hash('Manuf2026!')],
    ['u6', "Chef d'équipe sécurité", 'responsable', 'securite', 'e6', 'chef.securite@csrgroup.fr', hash('Secu2026!')],
    ['u7', 'Technicien sûreté', 'employe', 'surete', 'e7', 'technicien.surete@csrgroup.fr', hash('Surete2026!')],
  ];
  for (const u of users) {
    await pool.query('INSERT INTO users (id,name,role,entity_id,employee_id,email,password_hash) VALUES ($1,$2,$3,$4,$5,$6,$7)', u);
  }
