...
async function seedIfEmpty() {
  ...
  try {
    ...
    for (const t of tx) {
      await q('INSERT INTO transactions (id,entity_id,date,label,category,amount,type) VALUES ($1,$2,$3,$4,$5,$6,$7)', t);
    }
    ...
    for (const c of cards) {
      await q('INSERT INTO cards (id,entity_id,holder,last4,status,limit_amount,spent) VALUES ($1,$2,$3,$4,$5,$6,$7)', c);
    }
    ...
    for (const i of invoices) {
      await q('INSERT INTO invoices (id,entity_id,kind,number,counterparty,amount,due,status) VALUES ($1,$2,$3,$4,$5,$6,$7,$8)', i);
    }
    ...
    for (const p of products) {
      await q('INSERT INTO products (id,entity_id,name,sku,category,price,cost,active) VALUES ($1,$2,$3,$4,$5,$6,$7,1)', p);
    }
    ...
    for (const s of stock) {
      await q('INSERT INTO stock (id,entity_id,product_id,qty,threshold,unit) VALUES ($1,$2,$3,$4,$5,$6)', s);
    }
