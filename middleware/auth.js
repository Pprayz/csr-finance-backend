...
const ROLE_VIEWS = {
  directeur: ['dashboard','tresorerie','depenses','facturation','employes','planning','salaires','budget','stock','produits','acces','formations'],
  responsable: ['tresorerie','depenses','facturation','employes','planning','budget','stock','produits','monespace','formations'],
  employe: ['monespace','planning','formations'],
};
